...
```shell
curl "https://console.fieldwire.net/api/v2/projects/aceb1617-2dcf-4b01-a6b1-d8ae02bc3027/teams" \
...
`GET https://console.fieldwire.net/api/v2/projects/<Project ID>/teams`
...
```shell
curl "https://console.fieldwire.net/api/v2/projects/aceb1617-2dcf-4b01-a6b1-d8ae02bc3027/teams/fa1fe4df-39ad-42e6-b11a-af7f2b97cf75" \
  -H "Authorization: Token api=[api token]>,project=[project token]"
```
...
`GET https://console.fieldwire.net/api/v2/projects/<Project ID>/teams/<Team ID>`
...
`POST https://console.fieldwire.net/api/v2/projects/<Project ID>/teams`
...
`PATCH https://console.fieldwire.net/api/v2/projects/<Project ID>/teams/<Team ID>`
...
```shell
curl "https://console.fieldwire.net/api/v2/projects/aceb1617-2dcf-4b01-a6b1-d8ae02bc3027/teams/75d68ca1-0fc1-456a-bd9d-8b23875ac540" \
  -X DELETE \
  -H "Authorization: Token api=[api token]>,project=[project token]" \
  -H "Content-type: application/json"
```
...
`DELETE https://console.fieldwire.net/api/v2/projects/<Project ID>/teams/<Team ID>`
